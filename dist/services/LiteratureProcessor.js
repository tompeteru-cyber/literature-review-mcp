...
export class LiteratureProcessor {
     ...
     */
    async searchDatabases(databases, query, dateRange, fields) {
        const results = [];
     ...
     */
    async searchSingleDatabase(database, query, dateRange, fields) {
     ...
     */
    async extractMethodologies(paperPaths, extractionDepth = 'detailed') {
     ...
     */
    async parseMethodology(text, depth) {
        const methodology = {
            approach: '',
            data_collection: '',
            analysis_methods: [],
     ...
     */
    async validateMethodology(methodology, validationCriteria) {
        const issues = [];
     ...
     */
    async analyzeCitations(papers, analysisType = 'network-analysis', visualize = false) {
        const network = {
            nodes: [],
            edges: [],
            clusters: {},
     ...
     */
    async crossReference(primaryResults, secondaryDatabases, deduplication = true) {
        ...
        const uniqueFindings = this.identifyUniqueFindings(primaryResults, secondaryResults);
        return {
    ...
    analyzeOverlap(primary, secondary) {
    ...
    mergeAndDeduplicate(primary, secondary) {
    ...
    mergeAll(primary, secondary) {
        // Merge without deduplication
        return {
            total_papers: 0
        };
    }
    identifyUniqueFindings(primary, secondary) {
...
//# sourceMappingURL=LiteratureProcessor.js.map