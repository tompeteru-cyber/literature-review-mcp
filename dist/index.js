...
async function generateMockData(toolName, args) {
    switch (toolName) {
...
async function saveToolResult(toolName, result) {
    switch (toolName) {
        ...
        case 'generate_presentation':
            return await outputManager.savePresentation(result.mockData, result.arguments.format || 'powerpoint');
        case 'generate_paper_summary':
            return await outputManager.savePaperSummary(result.mockData, result.arguments.theme || 'general', result.arguments.output_format || 'markdown');
        ...
        case 'get_research_context':
            return await outputManager.saveReport('research-context', result.mockData, 'json');
        default:
